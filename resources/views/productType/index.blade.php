            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="">
                        <span class="badge">
                            <a data-toggle="collapse" href="#productType" class="text-primary" aria-expanded="false" aria-controls="filter">
                                <i class="fas fa-filter"></i>
                            </a>
                        </span>
                        </div>
                    </div>
                    <form action="{{ route('product-type.index') }}" method="GET">
                        <div class="collapse {{ request()->all() ? 'show' : ' ' }}" id="productType">
                            <div class="row">
                                <div class="col-md-3">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                ...
                                <a class="badge badge-outline-primary" href="{{ route('product-type.index') }}"><i
