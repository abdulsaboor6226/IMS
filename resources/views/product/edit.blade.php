                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="date" name="stock_date" value="{{old('stock_date',$product->stock_date)}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single w-100" required name="product_type_id_fk">
                                            ...
                                            @foreach($productTypes as $key =>$value)
                                                <option {{$product->product_type_id_fk == $key ? 'selected': " "}} value="{{$key}}">{{$value}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single w-100" required name="brand_id_fk">
                                            ...
                                            @foreach($brands as $key =>$value)
                                                <option {{$product->brand_id_fk == $key ? 'selected': " "}} value="{{$key}}">{{$value}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="js-example-basic-single w-100" required name="vendor_id_fk">
                                            ...
                                            @foreach($vendors as $value)
                                                <option {{$product->vendor_id_fk == $value->id ? 'selected': " "}} value="{{$value->id}}">{{$value->name}} - {{$value->phone}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" min="0.00" step="0.01" name="unit_price" value="{{old('unit_price',$product->unit_price)}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="number" name="unit_quantity" value="{{old('unit_quantity',$product->unit_quantity)}}" class="form-control">
                                    </div>
                                </div>
                            </div>
                        </div>
